...
<div style="padding-left: 20px; padding-top: 2px;">
		<h2 style="margin: 0">POS and Inventory System</h2>
	</div>
</header>
<div class="main">
...
<h1 class="text-success text-center">Transaction Complete</h1>
<center><p>Payment Successful. Thank you for your payment!</p></center>
<small class=""><a class="btn btn-primary" href="<?php echo base_url('pos')?>">Return To POS</a></small>
<br>
<br>
<div class="row">
